...
Dicebox158Gd::Dicebox158Gd(){
    ...
    if ( masterVector.size() == 0 ) { masterVector.push_back(this); }
...
Dicebox158Gd::~Dicebox158Gd(){
    ...
    for (G4std::vector<Dicebox158Gd*>::iterator i=masterVector.begin();
        ...
        if (*i == this) { masterVector.erase(i); break; }
    }
}

//PostPostStepDoIt
G4VParticleChange*
Dicebox158Gd::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep) {
...
G4VParticleChange*
Dicebox158Gd::GenericPostStepDoIt(const G4Step *pStep) {
